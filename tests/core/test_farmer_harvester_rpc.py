...
from deafwave.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from deafwave.protocols import farmer_protocol
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "zzz"), encode_puzzle_hash(new_ph_2, "zzz"))
