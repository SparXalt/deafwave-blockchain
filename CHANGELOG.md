...
- Mainnet uses port 8620 and other constants and service names were changed for mainnet.
...
- Testnet is now running at the primary port of 58620. Update your routers appropriately. This opens 8620 for mainnet.
...
- Introducer now makes sure it only sends peer addresses to peers of peers that it can reach on port 8620 or their UPnP port.
