...
from deafwave.util.significant_bits import count_significant_bits, truncate_to_significant_bits
...
def _get_second_to_last_transaction_block_in_previous_epoch(
    ...
    assert height_prev_epoch_surpass % constants.EPOCH_BLOCKS == height_prev_epoch_surpass % EPOCH_BLOCKS == 0
