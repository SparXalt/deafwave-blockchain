...
class ConsensusConstants:
    ...
    # The next block can have a timestamp of at most these many seconds more
    MAX_FUTURE_TIME: int
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M deafwave.
    MAX_COIN_AMOUNT: int
